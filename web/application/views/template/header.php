                        ...
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="<?= base_url('assets/app/profile/') . $user['image']; ?>" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
                                                <h4><?= $user['name']; ?></h4>
                                    ...
                                    <li>
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('user/changepassword'); ?>">Account Setting</a>
                                        <div class="dropdown-divider"></div>
